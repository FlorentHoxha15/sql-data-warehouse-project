...
Purpose:
    ...
    The Gold layer represents business-ready data that can be used for
    reporting, analytics, and BI tools such as Power BI.
...
SELECT 
    ...
    -- ERP gender is used when CRM does not contain a valid value.
    CASE 
...
-- Historical product records have an end date.
...
/* =============================================================================
   Create Fact Table View: gold.fact_sales
============================================================================= */
...
SELECT
    ...
    -- Surrogate keys from the Gold dimensions
    pr.product_key,
    cu.customer_key,
